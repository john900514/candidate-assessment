        ...
        <template v-slot:content>
            <div id="content" class="bg-slate-500 pt-[30%] md:pt-[15%] pb-12 md:pb-32">
                <div class="section-heading text-center pt-8 pb-12">
                    <h1 class="text-4xl md:text-6xl uppercase font-black tracking-wide pb-8 text-black">Free Trial</h1>
                    <div id="mediaWrapper">
                        <img :src="bannerImg" id="bannerImg" alt="Banner Image">
                    </div>
                </div>
                    ...
                    <form @submit.prevent="submit()">
                        <div class="flex flex-col md:flex-wrap md:flex-row mx-4 my-12 justify-between">
                            ...
                            <div class="form-group md:w-[50%] pt-4 md:pt-0">
                                <input type="text" class="w-full bg-white rounded-[0px] border-black text-black" v-model="form.last_name" placeholder="Last Name" required>
                            </div>
                        ...
                        <div class="form-group pt-1 mx-4 ">
                            <select v-model="form.club_id" class="w-full bg-white text-black rounded-[0px] " required>
                                <option value="">Select a Club</option>
                                <option v-for="(name, id) in clubs" :Value="id">{{ name }}</option>
                            </select>
                        ...
                        <div class="pt-8">
                            <button type="submit" class="btn btn-secondary uppercase h-20 text-xl tracking-widest px-12" :disabled="loading">Get a Free Visit</button>
                        </div>
                    </form>
                </div>
            </div>
